...
export default defineConfig({
  ...
  build: {
    ...
    outDir: resolve(import.meta.dirname, '../src/main/resources/META-INF/resources/webjars/security/vue'),
    emptyOutDir: true,
    rollupOptions: {
  ...
  server: { port: 5312, proxy: { '/rest': { target: 'http://localhost:8080', changeOrigin: true }, '/webjars': { target: 'http://localhost:8080', changeOrigin: true } } },
